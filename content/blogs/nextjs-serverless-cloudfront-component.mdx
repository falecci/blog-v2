export const metadata = {
  ...
  description:
    "How to work around NextJS Serverless Component creating a CloudFront Distribution on each deployment",
  thumbnail: "/nextjs-serverless-cloudfront-component/serverless-component.png",
};
...
![](/nextjs-serverless-cloudfront-component/pipeline.png)
...
Anyways, I love the idea of Serverless Components and how _EASY_ applications deployment and configuration are. I strongly believe it's game changing for sure. It's sad that they don't receive the attention they deserve.
