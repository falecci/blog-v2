export const metadata = {
  ...
  thumbnail:
    "https://ik.imagekit.io/visionsocial/blog/save-debugging-time-when-using-sinon-stubs.png?updatedAt=1722526450433",
};
...
it("retrieves an item by id", async () => {
  ...
  dbStub.find.withArgs(fakeId).resolves(fakeItem);
